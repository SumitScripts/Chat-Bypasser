...
Text = "Chat Bypass Made By SumitScriptsYT"; -- what the text says (ofc)
...
--[[
Chat Bypass/Hacker Chat Made By SumitScriptsYT
How is works:- This Script You Use A Gui Pop You Chat Anything with it your chat box change colour into Yellow Bypasser You Can Say Fuck,Ass,discord,MotherFucker,Etc
...
title.Text = "Chat Yellow Bypasser By SumitScriptsYT"
